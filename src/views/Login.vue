...
<script>
import { mapState } from "vuex";  //33vuex经典案例46.30mapState多种写法
//1.01鉴权

// 2mapState("loginUser",{loading:"loading"})//映射到局部计算属性
...
export default {
  ...
  computed: {//将vuex中的loading数据拿到此文件计算属性中直接使用
    ...mapState("loginUser", ["loading"]),//...mapState(['loading']),
  },
  methods: {
    async handleSubmit () {
